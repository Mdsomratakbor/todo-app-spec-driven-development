...
### Task 5.2 — Implement ITodoService: Create
...
### Task 5.3 — Implement TodoService: GetById and List (all)
...
### Task 5.4 — Implement TodoService: Update and Delete
...
### Task 5.5 — Implement TodoService: Filter and search
...
### Task 5.6 — Create TodoController: Create and List
...
### Task 5.7 — Create TodoController: GetById, Update, Delete
...
### Task 6.1 — Create Angular project with routing
- **Requirement**: N/A (infrastructure)
- **Dependencies**: None
...
### Task 6.2 — Add Angular Material and configure theme
- **Requirement**: N/A (infrastructure)
- **Dependencies**: 6.1
...
### Task 6.3 — Create shared API response model and AppConfig
...
### Task 6.4 — Set up HttpClient and AuthInterceptor
...
### Task 6.5 — Configure routes and AuthGuard
...
### Task 7.1 — Create AuthService with login and register
- **Requirement**: REQ-AUTH-001, REQ-AUTH-002
- **Dependencies**: 6.4
...
### Task 7.2 — Create LoginComponent — template
- **Requirement**: REQ-AUTH-002 (successful login, invalid credentials)
...
### Task 7.3 — Create LoginComponent — logic
- **Requirement**: REQ-AUTH-002 (both scenarios)
- **Dependencies**: 7.2
...
### Task 7.4 — Create RegisterComponent
...
### Task 8.1 — Create CategoryService
- **Requirement**: REQ-CAT-001, REQ-CAT-002, REQ-CAT-003, REQ-CAT-004
- **Dependencies**: 6.4
...
### Task 8.2 — Create CategoryListComponent
...
### Task 8.3 — Create CategoryFormComponent (dialog)
...
### Task 8.4 — Add delete confirmation with todo warning
...
### Task 9.2 — Create TodoListComponent — template
...
### Task 9.3 — Create TodoListComponent — logic
...
### Task 9.4 — Create TodoFormComponent — template
...
### Task 9.5 — Create TodoFormComponent — logic
...
### Task 9.6 — Implement completion toggle and delete
